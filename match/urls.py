...
urlpatterns = [
    ...
    path('write_review/<str:profile_name>', views.write_review, name='write_review'),
    path('write_review_matched/<str:profile_name>', views.write_review_matched, name='write_review_matched'),
